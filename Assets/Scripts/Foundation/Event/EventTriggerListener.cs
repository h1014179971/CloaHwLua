...
IMoveHandler
{
    public TouchHandle onClick = new TouchHandle();
    public TouchHandle onDoubleClick = new TouchHandle();
    public TouchHandle onDown = new TouchHandle();
    public TouchHandle onEnter = new TouchHandle();
    public TouchHandle onExit = new TouchHandle();
    public TouchHandle onUp = new TouchHandle();
    public TouchHandle onSelect = new TouchHandle();
    public TouchHandle onUpdateSelect = new TouchHandle();
    public TouchHandle onDeSelect = new TouchHandle();
    public TouchHandle onDrag = new TouchHandle();
    public TouchHandle onDragEnd = new TouchHandle();
    public TouchHandle onDrop = new TouchHandle();
    public TouchHandle onScroll = new TouchHandle();
    public TouchHandle onMove = new TouchHandle();
