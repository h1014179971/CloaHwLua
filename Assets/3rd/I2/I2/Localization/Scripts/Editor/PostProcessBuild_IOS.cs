        ...
        public static void ChangeXcodePlist(BuildTarget buildTarget, string pathToBuiltProject)
        {
			...
			//--[ Localize App Name ]----------
				...
				foreach (var code in langCodes)
				{
					...
					var InfoATTPlist = string.Format("NSUserTrackingUsageDescription =  \"{0}\";", LocalizationManager.GetAppATT(code));
					string[] infoPlists = new string[] { InfoPlist, InfoATTPlist };
					File.WriteAllLines(infoPlistPath, infoPlists);
