...
namespace I2.Loc
{
	public abstract partial class LocalizationEditor : Editor
	{
		...
		SerializedProperty 	mProp_Assets, mProp_Languages, 
							...
							mProp_OnMissingTranslation, mProp_AppNameTerm,mProp_AppNameAnroid, mProp_ATTTerm, mProp_IgnoreDeviceLanguage, mProp_Spreadsheet_SpecializationAsRows, mProp_GoogleInEditorCheckFrequency,
		...
		public void Custom_OnEnable( LanguageSourceData sourceData, SerializedProperty propSource)
		{
			...
			mProp_AppNameAnroid                    = propSource.FindPropertyRelative("mTerm_AppName_Android");
			mProp_ATTTerm						   = propSource.FindPropertyRelative("mTerm_AppATT");
