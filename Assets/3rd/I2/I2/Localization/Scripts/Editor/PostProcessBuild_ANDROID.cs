...
namespace I2.Loc
{
	public class PostProcessBuild_Android
	{
        ...
        public static void PostProcessAndroid(BuildTarget buildTarget, string pathToBuiltProject)
		{
            ...
            SetStringsFile( pathToBuiltProject+"/res/values", "strings.xml", stringXML, LocalizationManager.GetAppName(langCodes[0], buildTarget.ToString()) );
			...
			foreach (var code in langCodes)
			{
                ...
                SetStringsFile( dir, "strings.xml", stringXML, LocalizationManager.GetAppName(code, buildTarget.ToString()) );
			}
		}
