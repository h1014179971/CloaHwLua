...
namespace Pathfinding {
	...
	public class PointGraphEditor : GraphEditor {
		public override void OnInspectorGUI (NavGraph target) {
			...
			//graph.validTag = EditorGUILayout.TagField(new GUIContent("Valid Tag", "If root is not set, all objects with this tag will be used as nodes"), graph.validTag);

			
			graph.validTag = EditorGUILayoutx.TagField("Valid Tag", graph.validTag);
